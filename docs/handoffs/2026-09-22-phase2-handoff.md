...
Check, in this order: `gh pr view 6` (merged?), `gh run list --branch feat/phase2-search` (CI). The Phase 2 review is filed; a review of the review fixes themselves has not been run.
